...
if [ "$HAS_DISPLAY" = true ]; then
    ...
    sudo apt-get install -y kitty keepassxc haruna steam-installer ubuntu-restricted-extras timeshift solaar papirus-icon-theme bibata-cursor-theme peek onedrive
